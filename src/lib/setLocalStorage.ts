...
export default function addToLocalStorage(key:string, item:string) {
...
export async function removeFromLocalStorage(key:string, item:string) {
...
export async function updateLocalStorage(key:string, item:string, newitem:string){
